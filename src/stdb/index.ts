...
import SpectatorsRow from "./spectators_table";
...
const tablesSchema = __schema({
  ...
  shots: __table({
    name: 'shots',
    indexes: [
      { accessor: 'id', name: 'shots_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'shots_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, ShotsRow),
  spectators: __table({
    name: 'spectators',
    indexes: [
      { accessor: 'identity', name: 'spectators_identity_idx_btree', algorithm: 'btree', columns: [
        'identity',
      ] },
    ],
    constraints: [
      { name: 'spectators_identity_key', constraint: 'unique', columns: ['identity'] },
    ],
  }, SpectatorsRow),
});
